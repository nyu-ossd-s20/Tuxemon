...
def open_dialog(control, text, avatar=None, menu=None):
    ...
    """
    rect = calc_dialog_rect(control.screen.get_rect())
    return control.push_state("DialogState", text=text, avatar=avatar, rect=rect, menu=menu)
