...
class WorldState(state.State):
    ...
    def startup(self):
        ...
        self.screen = self.control.screen
    ...
    def set_transition_surface(self, color=(0, 0, 0)):
        self.transition_surface = pygame.Surface(self.control.screen.get_size())
    ...
    def broadcast_player_teleport_change(self):
        ...
        self.control.event_data["transition"] = False
        ...
        for npc in self.npcs.values():
            ...
            networking.update_client(npc, char_dict, self.control)
    ...
    def process_event(self, event):
        ...
        if event.button == intentions.WORLD_MENU:
            if event.pressed:
                ...
                self.control.push_state("WorldMenuState")
                return
    ...
    def move_npcs(self, time_delta):
        ...
        for entity in self.get_all_entities():
            ...
            if entity.update_location:
                ...
                networking.update_client(entity, char_dict, self.control)
    ...
    def change_map(self, map_name):
        ...
        self.control.load_map(map_data)

        # Clear out any existing NPCs
        self.npcs = {}
        self.npcs_off_map = {}
        self.add_player(self.control.player)
                ...
                if self.player1.facing == direction:
                    ...
                    for npc in self.npcs.values():
                        ...
                        if tile_pos == tile:
                            ...
                            self.control.push_state("InteractionMenu")
                            return True
                        else:
                            continue
    ...
    def handle_interaction(self, event_data, registry):
        ...
        networking.update_client(target, event_data["char_dict"], self.control)
            ...
            if not event_data["response"]:
                ...
                if self.wants_duel:
                    if event_data["response"] == "Accept":
                        ...
                        self.control.server.notify_client_interaction(cuuid, event_data)
